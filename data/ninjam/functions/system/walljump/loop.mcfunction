execute if entity @s[predicate=ninjam:sprinting,predicate=ninjam:on_air] unless entity @e[type=minecraft:area_effect_cloud,tag=ninjam_jumping,distance=..0.5] run function ninjam:system/walljump/check_1.15
