...
execute if score McVersion fktool matches ..115 align xyz run tp @e[type=minecraft:shulker,tag=ninjam_crawling,tag=ninjam_crawling_init,limit=1,sort=nearest] ~.5 ~1 ~.5
execute if score McVersion fktool matches 116.. at @s align xyz run tp @e[type=minecraft:shulker,tag=ninjam_crawling,tag=ninjam_crawling_init,limit=1,sort=nearest] ~.5 ~1 ~.5
