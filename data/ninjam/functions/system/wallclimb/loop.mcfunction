...
execute as @e[type=area_effect_cloud,tag=ninjam.climbing,scores={ninjam.Option=0}] at @s run function ninjam:system/wallclimb/despawn
scoreboard players remove @e[type=area_effect_cloud,tag=ninjam.climbing,scores={ninjam.Option=1..},distance=..1] ninjam.Option 1