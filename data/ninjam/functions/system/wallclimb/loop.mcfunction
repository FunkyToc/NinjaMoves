execute if entity @s[predicate=ninjam:sneaking,predicate=ninjam:on_air] unless entity @e[type=minecraft:area_effect_cloud,tag=ninjam_climbing,distance=..0.5] run function ninjam:system/wallclimb/check_1.15
