execute if entity @s[predicate=ninjam:sneaking] unless entity @e[type=minecraft:area_effect_cloud,tag=ninjam_climbing,distance=..0.58] run function ninjam:system/wallclimb/check
