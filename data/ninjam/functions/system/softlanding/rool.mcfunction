...
# start
effect give @s[predicate=ninjam:softlanding/roll,tag=!ninjam.rollin] minecraft:speed 1 0 true
tag @s[predicate=ninjam:softlanding/roll,tag=!ninjam.rollin] add ninjam.rolling_1
tag @s[predicate=ninjam:softlanding/roll] add ninjam.rollin
tp @s[tag=ninjam.rolling_1] ~ ~ ~ ~ ~15

# display
execute if score ParkourParticules ninjam.Option matches 1 run function ninjam:system/softlanding/particule
