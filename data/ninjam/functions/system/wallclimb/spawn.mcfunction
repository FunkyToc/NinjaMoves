...
execute align xyz run summon minecraft:area_effect_cloud ~0.5 ~-0.5 ~0.5 {Tags:["ninjam_climbing","ninjam_climbing_init"],Duration:3601}
...
execute if score ParkourSounds NINJAM_Option matches 1 rotated ~ 0 positioned ^ ^ ^0.3 run function ninjam:system/wallclimb/sound