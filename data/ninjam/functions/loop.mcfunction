# systems
execute if score SoftLanding ninjam.Option matches 1 as @a[predicate=ninjam:requires] at @s run function ninjam:system/softlanding/loop
execute if score Crawl ninjam.Option matches 1 as @a[predicate=ninjam:requires] at @s run function ninjam:system/crawl/loop
execute if score WallClimb ninjam.Option matches 1 as @a[predicate=ninjam:requires] at @s run function ninjam:system/wallclimb/loop
