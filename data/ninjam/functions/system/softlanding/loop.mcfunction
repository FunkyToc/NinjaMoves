# ninjam_softlanding
execute as @s[predicate=ninjam:on_air,predicate=ninjam:sneaking] if score @s NINJAM_Jump >= MinAirTime NINJAM_Option if block ~ ~-1 ~ minecraft:air run function ninjam:system/softlanding/check
