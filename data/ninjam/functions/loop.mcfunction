...
# air timer 
execute as @a[predicate=ninjam:on_ground] run scoreboard players set @s NINJAM_Jump 0
execute as @a[predicate=ninjam:on_air] run scoreboard players add @s NINJAM_Jump 1