...
# test landing space
execute as @s[tag=ninjam_softlanding,predicate=ninjam:on_ground] rotated ~ 0 positioned ^ ^ ^1 unless block ~ ~ ~ #ninjam:rollable_1.15 run function ninjam:system/softlanding/clear
execute as @s[tag=ninjam_softlanding,predicate=ninjam:on_ground] rotated ~ 0 positioned ^ ^ ^2 unless block ~ ~ ~ #ninjam:rollable_1.15 run function ninjam:system/softlanding/clear
