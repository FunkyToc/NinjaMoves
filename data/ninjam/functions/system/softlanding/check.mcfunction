...
execute if score McVersion fktool matches ..11599 if block ~ ~-1.2 ~ #ninjam:softlanding/soft_1.15 run tag @s add ninjam.softlandingpro
...
execute unless block ~ ~-1.2 ~ #ninjam:softlanding/unlanding run tag @s add ninjam.softlanding