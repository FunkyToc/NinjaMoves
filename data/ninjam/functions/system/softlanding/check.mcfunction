...
execute if score McVersion fktool matches 11500 if block ~ ~-1.2 ~ #ninjam:softlanding/soft_1.15 run tag @s add ninjam.softlandingpro
...
execute if score McVersion fktool matches 11500 unless block ~ ~-1.2 ~ #ninjam:softlanding/unlanding_1.15 run tag @s add ninjam.softlanding
