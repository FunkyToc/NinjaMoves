...
execute if score ParkourParticules NINJAM_Option matches 1 positioned ^.6 ^ ^ unless block ~ ~ ~ #ninjam:climbable_1.15 run function ninjam:system/wallrun/particule
execute if score ParkourParticules NINJAM_Option matches 1 positioned ^-.6 ^ ^ unless block ~ ~ ~ #ninjam:climbable_1.15 run function ninjam:system/wallrun/particule
execute if score ParkourSounds NINJAM_Option matches 1 positioned ^.6 ^ ^ unless block ~ ~ ~ #ninjam:climbable_1.15 run function ninjam:system/wallrun/sound
execute if score ParkourSounds NINJAM_Option matches 1 positioned ^-.6 ^ ^ unless block ~ ~ ~ #ninjam:climbable_1.15 run function ninjam:system/wallrun/sound