execute if entity @s[predicate=fktool:entity/sneaking] unless entity @e[type=minecraft:area_effect_cloud,tag=ninjam_climbing,distance=...8] run function ninjam:system/wallclimb/check
