...
scoreboard players operation @e[predicate=ninjam:walljump/entity,tag=ninjam.jumping_init,sort=nearest,limit=1] ninjam.Jump = MaxWallJumpTime ninjam.Option
tag @e[predicate=ninjam:walljump/entity,tag=ninjam.jumping_init] remove ninjam.jumping_init
