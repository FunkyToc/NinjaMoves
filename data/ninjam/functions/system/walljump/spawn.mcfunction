...
scoreboard players operation @e[predicate=ninjam:walljump/entity,tag=ninjam.walljump.entity.init,sort=nearest,limit=1] ninjam.Jump = MaxWallJumpTime ninjam.Option
